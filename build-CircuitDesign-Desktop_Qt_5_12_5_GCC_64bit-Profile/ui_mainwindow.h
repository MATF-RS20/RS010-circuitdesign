...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget3->setGeometry(QRect(11, 11, 111, 66));
        ...
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/images/plus.png"), QSize(), QIcon::Normal, QIcon::Off);
        adderButton->setIcon(icon17);
        adderButton->setIconSize(QSize(20, 20));
        ...
        QIcon icon18;
        icon18.addFile(QString::fromUtf8(":/images/minus.png"), QSize(), QIcon::Normal, QIcon::Off);
        subtractorButton->setIcon(icon18);
        subtractorButton->setIconSize(QSize(20, 20));
        ...
        layoutWidget4->setGeometry(QRect(10, 10, 101, 136));
        ...
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/images/JK.png"), QSize(), QIcon::Normal, QIcon::Off);
        JKButton->setIcon(icon19);
        ...
        QIcon icon20;
        icon20.addFile(QString::fromUtf8(":/images/SR.png"), QSize(), QIcon::Normal, QIcon::Off);
        SRButton->setIcon(icon20);
        ...
        QIcon icon21;
        icon21.addFile(QString::fromUtf8(":/images/D.png"), QSize(), QIcon::Normal, QIcon::Off);
        DButton->setIcon(icon21);
        DButton->setIconSize(QSize(20, 20));
        ...
        QIcon icon22;
        icon22.addFile(QString::fromUtf8(":/images/T.png"), QSize(), QIcon::Normal, QIcon::Off);
        TButton->setIcon(icon22);
        TButton->setIconSize(QSize(20, 20));
